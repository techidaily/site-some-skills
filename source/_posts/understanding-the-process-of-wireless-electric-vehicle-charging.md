...
date: 2024-09-17T00:59:41.250Z
updated: 2024-09-18T04:31:12.567Z
tags:
  - cutting-edge
categories:
  - tech
...
* [The Challenges of Wireless EV Charging](https://win-dash.techidaily.com/1722976822942-get-your-free-epson-et-2750-drivers-installed-on-windows-pcs-today/)
...
[In smartphones](https://eaxpv-info.techidaily.com/new-2024-approved-free-yourself-from-cash-for-sound-the-best-18-audio-crackers-on-youtube/), the process works via magnets or pads that the phone must stay in contact with. In electric cars, the same basic concept is used on a larger scale with more power that allows for more space between the charging pad and the vehicle. An inductive charging pad lies on the ground, and the car is parked over it. Cameras inside the car tell the driver when they're correctly positioned over the charging pad.
 ...
 Where wireless smartphone charging is around 80% efficient with power transfer, wireless EV charging claims to be much better. Tech YouTuber Matt Ferrell in [one of his videos](https://www.anrdoezrs.net/links/3607085/type/dlg/sid/UUhtgUeUpU204311/https://www.youtube.com/watch?v=s8EF7ZGORS0) spoke with a company that makes wireless EV charging tech called [WiTricity](https://witricity.com/technology/). The company's CEO claims its wireless charging equipment is around 99% efficient. That would be about the same as plugging in at a charging station or at home.

 That's surprising as we'd expect a loss in efficiency due to charging wirelessly rather than plugging in. But other data appears to support this level of charging efficiency. The Rochester Institute of Technology's Green Technology Accelerator Center partnered with wireless charging company HEVO to conduct a study in which wireless EV charging was [95% efficient](https://www.rit.edu/affiliate/nysp2i/sites/rit.edu.affiliate.nysp2i/files/docs/resources/HEVO%5FEvaluates%5FWireless%5FEV%5FCharging%5FEfficiency.pdf) in prototype devices. Wireless charging of up to 120kW with 97% efficiency was conducted [in 2018](https://insideevs.com/news/340478/120-kw-wireless-charging-proves-97-efficient/) at the Department of Energy's Oak Ridge National Laboratory (ORNL).

 That doesn't mean we'll all be charging our Teslas wirelessly tomorrow; the tech is still very much in the testing phase. But WiTricity has already retrofitted multiple EV models with their tech that reportedly works well. Multiple [other countries](https://www.techradar.com/news/wireless-electric-car-charging-pads-now-available-for-drivers-of-special-renault-evs) are also testing it and working toward a mass market solution. If improved enough to be rolled out for mass adoption, wireless charging kits for current models would be widely available, and new EVs would have wireless charging capability built in.

 That could allow for, as Ferrell talked about in his video, more autonomy for [self-driving](https://www.reviewgeek.com/107497/i-took-a-ride-in-a-self-driving-car-and-didnt-die/) and self-parking cars. If they could charge themselves via pads built into parking spaces or roads, they wouldn't really need any human interaction to complete their tasks throughout the day. Eventually, last-mile fleet vehicles, for example, could charge by parking on or driving over wireless charging pads and not need to be plugged in throughout the day, though more improvements in autonomous driving tech are needed before that's even close to reality.

 In addition, Cornell University is already working on wireless charging pads that can be [implanted in the roadway](https://www.anrdoezrs.net/links/3607085/type/dlg/sid/UUhtgUeUpU204311/https://www.youtube.com/watch?v=8BQUIRBMSWA) and power your car as you drive. Drexel University is also developing [wireless charging tech](https://drexel.edu/news/archive/2022/June/frequency-tuning-wireless-electric-vehicle-charging) that could be built into roads and be better able to tolerate misalignments between charging pads.
...
Related: [Level 1, Level 2, or Level 3? EV Chargers Explained](https://visual-screen-recording.techidaily.com/unveiling-wintv-magic-compre-written-guide-to-capturing-live-on-windows-pc-for-2024/) 
 ...
 Charging speed is another hurdle. When this tech first started becoming popular a few years ago it only transferred power at [around 3.5kW](https://www.greencarreports.com/news/1130055%5Fwireless-ev-charging-gets-a-boost-single-standard-will-harmonize-systems-up-to-11-kw), according to Green Car Reports. At the time of writing, that speed has increased to 11kW, which is enough to add about 34 miles of power to the battery per hour of [charging](https://fox-friendly.techidaily.com/2024-approved-11-ultimate-phantom-4-accessories-to-purchase/). That's decently fast, especially if you'll be parked for a while, but it's a far cry from the average [DC fast charging (DCFC) station](https://visual-screen-recording.techidaily.com/unveiling-wintv-magic-compre-written-guide-to-capturing-live-on-windows-pc-for-2024/).
...
##  What's Next for Wireless EV Charging
 ...
 In development since around 2007, wireless EV charging could finally be coming to the mainstream in the next few years. The Society of Automotive Engineers (SAE) [ratified a standard](https://witricity.com/products/automotive/) for wireless EV charging in 2020, signaling it can be brought to the mass market. Once manufacturers have tested and developed the technology adequately, we'll probably start to see wireless charging come standard on electric cars.
