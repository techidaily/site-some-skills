...
date: 2024-10-10T19:15:16.601Z
updated: 2024-10-16T10:43:35.235Z
tags:
  - web
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/discord-logo-with-the-store-in-the-background-and-several-thumbs-down-icons.jpg
---
...
* Some profile customizations like banners and animated avatars are only available with Discord Nitro.
...
##  How to Customize Your Discord Profile
 ...
 If you want to customize your Discord profile, there are plenty of options available. At the most basic, you can upload an avatar to represent yourself and fill out a short bio to fill with personal information. Fancier options include setting an image as your profile banner, adding decoration around your avatar, and layering an animated effect across your whole profile.

 To theme your Discord profile on desktop, click your profile picture in the bottom-left and then click the pencil icon ("Edit Profile"). On mobile, swipe right to open the server browser, tap "You" from the bottom menu, then tap "Edit Profile".

 When you edit your profile on mobile, you might see a warning that you don't have "the ability to acquire new profile effects". If this happens, switch to desktop for the full experience.
...
##  The Discord Shop Is Overpriced
 ...
 The shop is where the problem with profile decorations comes in. Discord sells lots of avatar decorations and profile effects based on charming themes like anime, pirates, and cyberpunk.

 These start at a minimum of $5.99, going up to an eye-watering $12.99 for something from the SpongeBob SquarePants range. If you're a Discord Nitro member, you get a measly few dollars discount.
...
![Steam points shop.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/steam-points-shop.png) 
 ...
 All that said, the cosmetics are entirely optional—the core Discord experience isn't impacted. Discord itself is free to use, so you can happily chat to your friends without this bothering you, and if enough people are willing to buy these items to keep it that way, that's great.

---

 I'll keep using Discord for all its awesome features, like being able to [watch movies with friends](https://eaxpv-info.techidaily.com/new-in-2024-for-students-discover-the-top-10-historical-youtube-channels-now/). However, as much as I'd like to deck out my profile, I can't justify the cost.
